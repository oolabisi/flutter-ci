...
//		server = getAppiumServerDefault(); // -> If using Windows, uncomment this statement and comment above statement
	...
	public AppiumDriverLocalService getAppiumService() {
		...
		environment.put("PATH", "/Users/oogundairo/Downloads/apache-maven-3.9.2/bin:/Users/oogundairo/Library/Android/sdk/platform-tools:/Users/oogundairo/Library/Android/sdk/cmdline-tools:/Library/Java/JavaVirtualMachines/jdk-11.jdk/Contents/Home/bin:/usr/local/opt/node@18/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Library/Apple/usr/bin" + System.getenv("PATH"));
		environment.put("ANDROID_HOME", "/Users/oogundairo/Library/Android/sdk");
...
//	  ExtentReport.getTest().log(Status.INFO, msg);
  ...
  public String getText(WebElement e, String msg) {
	...
	public WebElement scrollToRenvault() {
		return getDriver().findElement(AppiumBy.androidUIAutomator(
				"new UiScrollable(new UiSelector()" + ".scrollable(true)).scrollIntoView("
						+ "new UiSelector().description(\"End date\"));"));
	}
